...
When using the free apps like Gmail, Calendar, and Docs the integration is the connection between the Gemini app (mobile on Android and iPhone, and the Gemini web app) and the data in Gmail, Calendar, and Docs.
